...
const Sidebar = ({ handle }: { handle: () => void }) => {
  ...
  return (
    ...
    <span className="hidden lg:block ml-2 text-xl font-bold">DuoExpense</span>
      </Link>
      <FiX className='block lg:hidden text-gray-500 cursor-pointer hover:text-gray-700 focus:outline-none' onClick={handle} size={24} />
    </div>
